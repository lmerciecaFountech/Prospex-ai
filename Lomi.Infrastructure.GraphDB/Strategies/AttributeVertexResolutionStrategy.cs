...
{
    public class AttributeVertexResolutionStrategy : IVertexResolutionStrategy
    {
        private string _id;

        public static AttributeVertexResolutionStrategy ForId(string id)
        {
            return new AttributeVertexResolutionStrategy
            {
                _id = id
            };
        }
        ...
        public async Task<Vertex> AddOrUpdateAsync(Entity entity)
        {
            ...
            {
                var possibleVertex = await gremlin.AddOrUpdateVertexAsync(this, VertexLabel.Attribute, entity);
